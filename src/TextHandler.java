...
p.sendQuest("", 15080);
if(p.bankPin != -1){
    p.sendQuest("@gre@Set", 15105);
}
if(p.bankPin == -1){
    p.sendQuest("@red@NONE", 15105);
}
p.sendFrame126("The Bank of Rs Reborn - Deposit Box", 7421);
p.sendQuest("The Bank of Rs Reborn - Bank Pin", 14923);
p.sendQuest("", 15107);
p.sendQuest("Set Pin", 15078);
p.sendQuest("Delete Pin", 15082);
p.sendQuest("", 15107);
p.sendQuest("Set Pin", 15078);
p.sendQuest("The Bank of Rs Reborn",5383);
p.sendQuest("",4439);
        ...
        p.sendQuest("Stab", 2439);
        p.sendQuest("Slash", 2438);
        p.sendQuest("Lunge", 2437);
        p.sendQuest("Block", 2440);
        p.sendQuest("", 2441);
        p.sendQuest("", 2442);
        p.sendQuest("", 2443);
        p.sendQuest("", 2444);
        ...
        p.sendFrame126("@whi@Home", 180);
        p.sendFrame126("@gre@Train", 181);
        p.sendFrame126("@bla@Veng", 178);
        ...
        p.sendFrame126("@gre@Tele", 157);
        p.sendFrame126("@gre@Anim", 156);
