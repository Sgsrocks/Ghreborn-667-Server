...
if (!Item4.isFullHelm(playerEquipment[playerHat]) && !Item4.isFullMask(playerEquipment[playerHat]) && (playerLook[0] != 1))
...
str.writeWordBigEndian(
(playerEmotionReq == -1) ? 65535 : playerEmotionReq);
