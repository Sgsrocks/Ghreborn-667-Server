    ...
    public static PlayerSave loadGame(String playerName) {
        ...
        try {
            ObjectInputStream in = new ObjectInputStream(
                    new FileInputStream("./Data/savedGames/" + playerName + ".dat"));
        ...
        try {
            ObjectOutputStream out = new ObjectOutputStream(
                    new FileOutputStream(
                            "./Data/savedGames/" + plr.playerName + ".dat"));
    ...
    public static void main(String[] args) {
        if (args.length == 1) {
            ...
            if (loadgame != null) {
                ...
                saveGame(loadgame);
                System.out.println(
                        args[0] + "'s new pass is: \"" + loadgame.playerPass
                        + "\"");
            } else {
            ...
            try {
                ...
                if (loadgame != null && word.equalsIgnoreCase("setExp")) {
                    ...
                    saveGame(loadgame);
                    System.out.println(
                            num1 + "'s new xp is: " + loadgame.playerXP[num1]);
                } else if (loadgame != null && word.equalsIgnoreCase("showExp")) {
                    System.out.println(
                            "Skill(" + num1 + ") : " + loadgame.playerXP[num1]
                            + " xp");
                } else {
                    System.out.println("Profile not found!");
                }
